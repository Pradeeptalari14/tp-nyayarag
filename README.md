# ⛓️ NyayaRAG (Indian SC Judgments)

> Graph-structured legal reasoning engine processing Indian Supreme Court case histories.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/nyayarag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-nyayarag.git
cd tp-nyayarag
```
...
```bash
kubectl port-forward deployment/tp-nyayarag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── nyaya_graph_rag.py     # Main configuration file
```
...
---
*Generated by [NyayaRAG (Indian SC Judgments) Studio](https://pradeeptalari14.github.io/portfolio/tools/nyayarag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
