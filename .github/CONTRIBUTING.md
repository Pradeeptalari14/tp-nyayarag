...
Thank you for your interest in improving the **NyayaRAG (Indian SC Judgments)** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-nyayarag.git
...
Generated configurations come from the **[NyayaRAG (Indian SC Judgments) Studio](https://pradeeptalari14.github.io/portfolio/tools/nyayarag/)**.
